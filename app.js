...
const levels = [
  // Level 1
  {
    platforms: [
      ...
      { x: 500, y: 369, width: 300, height: 40, type: "ground" },
      { x: 200, y: 289, width: 60, height: 20, type: "floating" },
